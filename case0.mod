...
################################# 
s.t. COMPARISON_A_11 {i in L2,j in K}:
AXij[i,j] <= SL;

s.t. COMPARISON_B_11 {i in L2,j in K}:
BXij[i,j] <= SL;

s.t. COMPARISON_C_11 {i in L2,j in K}:
CXij[i,j] <= SL;

s.t. COMPARISON_D_11 {i in L2,j in K}:
DXij[i,j] <= SL;



s.t. COMPARISON_A_12 {i in L2,j in K}:
AXij[i,j] >= 0;

s.t. COMPARISON_B_12 {i in L2,j in K}:
BXij[i,j] >= 0;

s.t. COMPARISON_C_12 {i in L2,j in K}:
CXij[i,j] >= 0;

s.t. COMPARISON_D_12 {i in L2,j in K}:
DXij[i,j] >= 0;


s.t. COMPARISON_A_21 {i in L2,j in K}:
AYij[i,j] >= -SW;

s.t. COMPARISON_B_21 {i in L2,j in K}:
BYij[i,j] >= -SW;

s.t. COMPARISON_C_21 {i in L2,j in K}:
CYij[i,j] >= -SW;

s.t. COMPARISON_D_21 {i in L2,j in K}:
DYij[i,j] >= -SW;
